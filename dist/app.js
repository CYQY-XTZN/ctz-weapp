...
function App({
  ...
  (0,_tarojs_taro__WEBPACK_IMPORTED_MODULE_0__.useLaunch)(() => {
    ...
    // 初始化云开发（仅在微信小程序中）
    if (true) {
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default().cloud.init({
        env: 'cloud1-7gg10sorbbbec8d9',
        // ← 替换成你刚创建的环境 ID
        traceUser: true
      });
    }
...
var config = {"pages":["pages/welcome/index","pages/register/index","pages/birthdate/index","pages/birthtime/index","pages/gender/index","pages/relationship/index","pages/home/index","pages/constellation/index","pages/constellation/simple","pages/constellation-detail/index","pages/mountainPage/index","pages/mountains/jinxiu-mountain/index","pages/mountains/chongqing-mountain/index","pages/profile/index","pages/IPs/qinggeng/index","pages/IPs/feimian/index","pages/xingyouhui/index"],"window":{"backgroundTextStyle":"light","navigationBarBackgroundColor":"#ffffff","navigationBarTitleText":"太初泽","navigationBarTextStyle":"black","navigationStyle":"custom"},"style":"v2","sitemapLocation":"sitemap.json"};
_tarojs_runtime__WEBPACK_IMPORTED_MODULE_5__.taroWindowProvider.__taroAppConfig = config
var inst = App((0,_tarojs_plugin_framework_react_dist_runtime__WEBPACK_IMPORTED_MODULE_6__.createReactApp)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_app_app_ts__WEBPACK_IMPORTED_MODULE_2__["default"], react__WEBPACK_IMPORTED_MODULE_3__, react_dom__WEBPACK_IMPORTED_MODULE_4__["default"], config))
